...
export const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { to: '/admin/asignaturas', label: 'Asignaturas', icon: 'bi-journal-bookmark-fill' },
        { to: '/admin/grupos', label: 'Grupos', icon: 'bi-collection-fill' },
        { to: '/admin/inscripciones', label: 'Matriculaciones', icon: 'bi-person-check-fill' },
    ];
