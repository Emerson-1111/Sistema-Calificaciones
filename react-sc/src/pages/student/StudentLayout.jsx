...
export const StudentLayout = () => {
    ...
    const navItems = [
        { to: '/estudiante', label: 'Dashboard', icon: 'bi-speedometer2', end: true },
        { to: '/estudiante/grupo', label: 'Mi Grupo', icon: 'bi-collection-fill' },
        { to: '/estudiante/asignaturas', label: 'Mis Asignaturas', icon: 'bi-journal-bookmark-fill' },
        { to: '/estudiante/calificaciones', label: 'Mis Calificaciones', icon: 'bi-award-fill' },
    ];
